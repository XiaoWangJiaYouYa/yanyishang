...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        current_outcomes = dice()
        if current_outcomes==1:
            sow_sad=True
            pass
        sum_of_outcomes+=current_outcomes
        pass
    if not sow_sad:
...
def hefty_hogs(player_score, opponent_score):
    ...
    if opponent_score==0:
        ...
        while opponent_score !=0:
            ...
            mapped_f = digit_fn(right_most)
            player_score = mapped_f(player_score)
...
def hog_pile(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    player_right_most = player_score%10
    opponent_right_most = opponent_score%10
    if player_right_most!=opponent_right_most:
        return 0
    else:
        return player_right_most
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            score0+= take_turn(num_roll, score0, score1, dice, goal)
            score0+=hog_pile(score0, score1)
            pass
        if who==1:
            num_roll = strategy1(score1,score0)
            score1+= take_turn(num_roll, score1, score0, dice, goal)
...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    if score0>score1:
        ...
        if leader == last_leader:
            ...
            message='Player {} takes the lead by {}'.format(leader,score0-score1)
            pass
        pass
    elif score1>score0:
        leader=1
        if leader == last_leader:
            ...
            message='Player {} takes the lead by {}'.format(leader,score1-score0)
            pass
        pass
    else:
        leader=None
...
def make_averaged(original_function, total_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def make_averaged_core(*args):
        result=0
        for i in range(total_samples):
            result+=original_function(*args)
            pass
        return float(result)/float(total_samples)
        pass
    return make_averaged_core
    # END PROBLEM 8
...
def hefty_hogs_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_0_rolls =hefty_hogs(score, opponent_score)
    if score_0_rolls>=threshold:
        return 0
    else:
        return num_rolls
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    if hefty_hogs_strategy(score, opponent_score, threshold, num_rolls)==0:
        ...
        score_0_rolls = hefty_hogs(score, opponent_score)
        hog_Pile_value = hog_pile(score + score_0_rolls, opponent_score)
        if hog_Pile_value > 0:
            return 0
        else:
            return num_rolls
